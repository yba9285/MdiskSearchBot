...
class Config(object):
    API_ID = int(os.getenv("API_ID", "14088604"))
    API_HASH = os.getenv("API_HASH", "4e9179bd1845bee6bfd36b04f677995c")
    BOT_TOKEN = os.getenv("BOT_TOKEN", "5585766620:AAG-BIs3sCm-pRhZVPoXLoVhX26OVxdkqVA")
    BOT_SESSION_NAME = os.getenv("BOT_SESSION_NAME", "mdiskkbot")
    USER_SESSION_STRING = os.getenv("USER_SESSION_STRING", "1BVtsOMUBu5hWjBo-IsbQfXJkQOsP1MdyAdLtxMDf6EEc5V43nLiOLRXocUzOOdMXMqx92SyrVKeACX9Y84Pgv0Wk8qKn17ZseXiWkZCq4tQ2G7bgUHq8QIhq7Jji-aBwih2KRO1WWP_ItkebxLh-JH95EIXB8yOV_am9F1fZ1gUGqOyzAufPL7OXfGdn5reCjpL7lKLVrxS5XjQmRNvqaqF6BSNA0dn8W2Fg2KfRrED4UcgGOLPC0V77PPUfRXbFvtb7E0XMqhzKswrwZFkiCYASd8YllNgOnK0tqSnHQ0lecIOzFmkIaSVsytQ58XlGnSrnD3vnd-FVGRFVdiS42cmNGFFt12g=")
    CHANNEL_ID = int(os.getenv("CHANNEL_ID", "-1001749313453")) 
    BOT_USERNAME = os.getenv("BOT_USERNAME", "Onlymoviiefilterbot")
    BOT_OWNER = int(os.getenv("BOT_OWNER", "5376983178"))
#    OWNER_USERNAME = os.getenv("OWNER_USERNAME","onlymoviies")
    BACKUP_CHANNEL = os.getenv("BACKUP_CHANNEL", "visionloverz")
...
Jᴜsᴛ Tʏᴘᴇ ᴀ Mᴏᴠɪᴇ Nᴀᴍᴇ 🎬**""" ) 
    START_PHOTO = os.getenv("START_PHOTO", "https://telegra.ph/file/51bbd6440ab32019d8e78.jpg")
    HOME_TEXT = os.getenv("HOME_TEXT", """ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕

ɪ ᴄᴀɴ ᴘʀᴏᴠɪᴅᴇ ᴛʜᴇʀᴇ ʏᴏᴜʀ ʟɪɴᴋꜱ.

ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    UPDATES_CHANNEL = os.getenv("UPDATES_CHANNEL", "-1001810394853")
    DATABASE_URL = os.getenv("DATABASE_URL", "mongodb+srv://Yogiraj123:yogiraj123@cluster0.w2dxm.mongodb.net/?retryWrites=true&w=majority")
    LOG_CHANNEL = int(os.getenv("LOG_CHANNEL", "-1001561854778"))
    RESULTS_COUNT = int(os.getenv("RESULTS_COUNT", 20))
    BROADCAST_AS_COPY = os.getenv("BROADCAST_AS_COPY", "true")
    UPDATES_CHANNEL_USERNAME = os.getenv("UPDATES_CHANNEL_USERNAME", "visionloverz")
...
ᴅᴍ ꜰᴏʀ ᴀɴʏ Qᴜᴇʀʏ @hindimarathimoviezz 🤖""" )
    ABOUT_WATCH_TEXT = """
ʜᴇʏ ʙᴜᴅᴅʏ, 
